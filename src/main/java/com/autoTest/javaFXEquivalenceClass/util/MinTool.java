...
public class MinTool {
    ...
    public static int getStringIndex(List<StringTypeBean> stringTypeBeans, String uuid){
        int tempIndex=-1;
        String uuidTemp;
        for(int i=0;i<stringTypeBeans.size();i++){
            uuidTemp=stringTypeBeans.get(i).getUuid();
    ...
    public static int getInterIndex(List<InterTypeBean> interTypeBeans, String uuid){
        int tempIndex=-1;
        String uuidTemp;
        for(int i=0;i<interTypeBeans.size();i++){
            uuidTemp=interTypeBeans.get(i).getUuid();
            if(uuid.equals(uuidTemp)){
                tempIndex=i;
                break;
            }
    ...
    public static int getDateIndex(List<DateTypeBean> dateTypeBeans, String uuid){
        int tempIndex=-1;
        String uuidTemp;
        for(int i=0;i<dateTypeBeans.size();i++){
            uuidTemp=dateTypeBeans.get(i).getUuid();
            if(uuid.equals(uuidTemp)){
                tempIndex=i;
                break;
            }
    ...
    public static int getDecimalIndex(List<DecimalTypeBean> decimalTypeBeans, String uuid){
        int tempIndex=-1;
        String uuidTemp;
        for(int i=0;i<decimalTypeBeans.size();i++){
            uuidTemp=decimalTypeBeans.get(i).getUuid();
            if(uuid.equals(uuidTemp)){
                tempIndex=i;
                break;
            }
    ...
    public static int getEnumerationIndex(List<EnumerationTypeBean> enumerationTypeBeans, String uuid){
        int tempIndex=-1;
        String uuidTemp;
        for(int i=0;i<enumerationTypeBeans.size();i++){
            uuidTemp=enumerationTypeBeans.get(i).getUuid();
            if(uuid.equals(uuidTemp)){
                tempIndex=i;
                break;
            }
