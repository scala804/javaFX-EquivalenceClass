...
public class DateTimePicker extends HBox implements Initializable {
	...
	private DateTimeFormatter formatterTemp;

	public   final String DefaultFormat = "HH:mm:ss";
	...
	public DateTimePicker(final LocalDateTime dateTime, final DateTimeFormatter formatter) {
		...
		final FXMLLoader fxmlLoader = new FXMLLoader(
				getClass().getResource("/view/DateTimePicker.fxml"));
	...
	public void initialize(URL location, ResourceBundle resources) {
		String timeStringTemp=String.valueOf(dateTime.get());
        int intIndex=String.valueOf(dateTime.get()).indexOf("T");
        String timeString=timeStringTemp.substring(intIndex+1,intIndex+9);
