...
public class EnumerationTypeBean {
    private String uuid;
    ...
    private String successExpectedResults;
    ...
    public String getSuccessExpectedResults() {
        return successExpectedResults;
    }

    public void setSuccessExpectedResults(String successExpectedResults) {
        this.successExpectedResults = successExpectedResults;
    }
