...
public class InterTypeBean {
    ...
    private String interBeyondUpperBoundaryValue;
    private String otherNotInterExpectedResults;
    ...
    public String getInterBeyondLowerBoundaryValue() {
        return interBeyondLowerBoundaryValue;
    }

    public void setInterBeyondLowerBoundaryValue(String interBeyondLowerBoundaryValue) {
        this.interBeyondLowerBoundaryValue = interBeyondLowerBoundaryValue;
    }
    ...
    public String getInterBeyondUpperBoundaryValue() {
        return interBeyondUpperBoundaryValue;
    }

    public void setInterBeyondUpperBoundaryValue(String interBeyondUpperBoundaryValue) {
        this.interBeyondUpperBoundaryValue = interBeyondUpperBoundaryValue;
    }

    public String getOtherNotInterExpectedResults() {
        return otherNotInterExpectedResults;
    }

    public void setOtherNotInterExpectedResults(String otherNotInterExpectedResults) {
        this.otherNotInterExpectedResults = otherNotInterExpectedResults;
    }
}
